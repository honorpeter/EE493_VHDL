...
synth_design -top alu_tester -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef alu_tester.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file alu_tester_utilization_synth.rpt -pb alu_tester_utilization_synth.pb"
