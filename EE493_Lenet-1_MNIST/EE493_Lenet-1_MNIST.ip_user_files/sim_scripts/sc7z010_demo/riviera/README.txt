...
#
# Generated by export_simulation on Mon Apr 08 01:52:40 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './sc7z010_demo.sh' script.

./sc7z010_demo.sh -reset_run
...
./sc7z010_demo.sh -noclean_files

For more information on the script, please type './sc7z010_demo.sh -help'.
