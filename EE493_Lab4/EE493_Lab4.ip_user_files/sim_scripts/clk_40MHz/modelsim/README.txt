...
#
# Generated by export_simulation on Thu Apr 04 17:43:19 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './clk_40MHz.sh' script.

./clk_40MHz.sh -reset_run
...
./clk_40MHz.sh -noclean_files

For more information on the script, please type './clk_40MHz.sh -help'.
