...
#
# Generated by export_simulation on Thu Apr 04 21:23:47 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './clk_200MHz.sh' script.

./clk_200MHz.sh -reset_run
...
./clk_200MHz.sh -noclean_files

For more information on the script, please type './clk_200MHz.sh -help'.
