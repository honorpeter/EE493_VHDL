...
#
# Generated by export_simulation on Fri Apr 05 18:00:24 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './clk_148MHz.sh' script.

./clk_148MHz.sh -reset_run
...
./clk_148MHz.sh -noclean_files

For more information on the script, please type './clk_148MHz.sh -help'.
