...
#
# Generated by export_simulation on Fri Apr 05 17:04:12 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './clk_74MHz.sh' script.

./clk_74MHz.sh -reset_run
...
./clk_74MHz.sh -noclean_files

For more information on the script, please type './clk_74MHz.sh -help'.
